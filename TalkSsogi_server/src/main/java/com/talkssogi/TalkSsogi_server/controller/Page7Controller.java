...
public class Page7Controller {
    ...
    public Map<String, List<String>> getBasicRankingResults(@RequestParam String crnum) {
    ...
    public Map<String, List<String>> getSearchRankingResults(@RequestParam String crnum, String keyword) {
        // 기본 제공 랭킹 결과를 생성
